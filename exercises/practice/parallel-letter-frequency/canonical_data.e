...
{-1,
 ...
 {`cases`,
  {-2,
   {-1, {`uuid`, `c054d642-c1fa-4234-8007-9339f2337886`},
    {`description`, `no texts`}, {`property`, `calculateFrequencies`},
    {`input`, {-1, {`texts`, {-2}}}}, {`expected`, {-1}}},
   {-1, {`uuid`, `818031be-49dc-4675-b2f9-c4047f638a2a`},
    {`description`, `one text with one letter`},
    {`property`, `calculateFrequencies`},
    {`input`, {-1, {`texts`, {-2, `a`}}}}, {`expected`, {-1, {`a`, 1}}}},
   {-1, {`uuid`, `c0b81d1b-940d-4cea-9f49-8445c69c17ae`},
    {`description`, `one text with multiple letters`},
    {`property`, `calculateFrequencies`},
    {`input`, {-1, {`texts`, {-2, `bbcccd`}}}},
    {`expected`, {-1, {`b`, 2}, {`c`, 3}, {`d`, 1}}}},
   {-1, {`uuid`, `708ff1e0-f14a-43fd-adb5-e76750dcf108`},
    {`description`, `two texts with one letter`},
    {`property`, `calculateFrequencies`},
    {`input`, {-1, {`texts`, {-2, `e`, `f`}}}},
    {`expected`, {-1, {`e`, 1}, {`f`, 1}}}},
   {-1, {`uuid`, `1b5c28bb-4619-4c9d-8db9-a4bb9c3bdca0`},
    {`description`, `two texts with multiple letters`},
    {`property`, `calculateFrequencies`},
    {`input`, {-1, {`texts`, {-2, `ggh`, `hhi`}}}},
    {`expected`, {-1, {`g`, 2}, {`h`, 3}, {`i`, 1}}}},
   {-1, {`uuid`, `6366e2b8-b84c-4334-a047-03a00a656d63`},
    {`description`, `ignore letter casing`},
    {`property`, `calculateFrequencies`},
    {`input`, {-1, {`texts`, {-2, `m`, `M`}}}},
    {`expected`, {-1, {`m`, 2}}}},
   {-1, {`uuid`, `92ebcbb0-9181-4421-a784-f6f5aa79f75b`},
    {`description`, `ignore whitespace`},
    {`property`, `calculateFrequencies`},
    {`input`, {-1, {`texts`, {-2, `   `, "\t", "\r\n"}}}},
    {`expected`, {-1}}},
   {-1, {`uuid`, `bc5f4203-00ce-4acc-a5fa-f7b865376fd9`},
    {`description`, `ignore punctuation`},
    {`property`, `calculateFrequencies`},
    {`input`, {-1, {`texts`, {-2, `!`, `?`, `;`, `,`, `.`}}}},
    {`expected`, {-1}}},
   {-1, {`uuid`, `68032b8b-346b-4389-a380-e397618f6831`},
    {`description`, `ignore numbers`}, {`property`, `calculateFrequencies`},
    {`input`,
     {-1, {`texts`, {-2, `1`, `2`, `3`, `4`, `5`, `6`, `7`, `8`, `9`}}}},
    {`expected`, {-1}}},
   {-1, {`uuid`, `aa9f97ac-3961-4af1-88e7-6efed1bfddfd`},
    {`description`, `Unicode letters`}, {`scenarios`, {-2, `unicode`}},
    {`property`, `calculateFrequencies`},
    {`input`,
     {-1,
      {`texts`, {-2, {230,156,172}, {207,134}, {227,129,187}, {195,184}}}}},
    {`expected`,
     {-1, {{230,156,172}, 1}, {{207,134}, 1}, {{227,129,187}, 1},
      {{195,184}, 1}}}},
   {-1, {`uuid`, `7b1da046-701b-41fc-813e-dcfb5ee51813`},
    {`description`,
    ...
    {`expected`,
     {-1, {`a`, 32}, {`b`, 4}, {`c`, 6}, {`d`, 14}, {`e`, 37}, {`f`, 7},
      {`g`, 8}, {`h`, 29}, {`i`, 19}, {`k`, 6}, {`l`, 12}, {`m`, 7},
      {`n`, 19}, {`o`, 22}, {`p`, 7}, {`r`, 17}, {`s`, 16}, {`t`, 30},
      {`u`, 9}, {`v`, 2}, {`w`, 9}, {`y`, 4}}}},
   {-1, {`uuid`, `4727f020-df62-4dcf-99b2-a6e58319cb4f`},
    {`description`, `large texts`}, {`scenarios`, {-2, `concurrent`}},
    {`property`, `calculateFrequencies`},
    {`input`,
     {-1,
      {`texts`,
    ...
    {`expected`,
     {-1, {`a`, 845}, {`b`, 155}, {`c`, 278}, {`d`, 359}, {`e`, 1143},
      {`f`, 222}, {`g`, 187}, {`h`, 507}, {`i`, 791}, {`j`, 12}, {`k`, 67},
      {`l`, 423}, {`m`, 288}, {`n`, 833}, {`o`, 791}, {`p`, 197}, {`q`, 8},
      {`r`, 432}, {`s`, 700}, {`t`, 1043}, {`u`, 325}, {`v`, 111},
      {`w`, 223}, {`x`, 7}, {`y`, 251}}}},
   {-1, {`uuid`, `adf8e57b-8e54-4483-b6b8-8b32c115884c`},
    {`description`, `many small texts`}, {`scenarios`, {-2, `concurrent`}},
    {`property`, `calculateFrequencies`},
    {`input`,
     {-1,
      {`texts`,
       {-2, `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`,
        `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`,
        `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`,
        `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`,
        `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`,
        `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`, `abbccc`,
